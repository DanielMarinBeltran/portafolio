  ...
  return (
    <div className='container'>
      ...
      <Box>
        ...
        <Typography>After we have installed all the dependecies we can proceed to create a folder named redux in the src folder and, then create the file named <strong>store.js</strong> and a folder named <strong>reducers</strong> (inside of this folder we will create a file named <strong>index.js</strong>, here is where we will create the reducers that we will use in every segment of our App) also a folder named <strong>types</strong> (inside of this folder we will create a file named <strong>index.js</strong>), and a last one named <strong>actions</strong> as the picture bellow.</Typography>
